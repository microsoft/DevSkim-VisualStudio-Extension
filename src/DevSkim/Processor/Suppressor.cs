...
namespace DevSkim
{
    ...
    public class Suppressor
    {
        ...
        /// <param name="contentType">Visual Studio content yype</param>
        public Suppressor(string lineOfCode, string contentType)
        {
            _text = lineOfCode;
        ...
        public string SuppressRule(string ruleId, DateTime date)
        {
            ...
            {
                result = string.Concat(result, " ", Language.Comment(command, _contentType));
            }
